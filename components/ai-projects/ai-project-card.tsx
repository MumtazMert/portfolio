      ...
      <motion.div variants={itemVariants}>
         <Card className="bg-[#151515] border-[#2a2a2a] overflow-hidden h-full flex flex-col">
            <div className="relative h-48 overflow-hidden group">
               ...
               <div className="absolute top-4 right-4 p-2 bg-[#151515]/80 rounded-full">{project.icon}</div>
            </div>
            <CardContent className="p-6 flex-grow flex flex-col">
               ...
               <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, tagIndex) => (
                     <span key={tagIndex} className="px-2 py-1 bg-[#252525] text-xs rounded-full text-slate-300">
                        {tag}
                     </span>
                  ))}
               </div>
               <div className="flex gap-3">
                  ...
                  <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex-1">
                     <Button size="sm" className="bg-primary hover:bg-primary/80 w-full">
